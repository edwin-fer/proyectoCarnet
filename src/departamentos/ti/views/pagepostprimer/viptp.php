        ...
        <section class="filtros">
            ...
            <div class="bloqFiltro">
                ...
                <form action="../../controlers/controlerscvs/actualizarcvs.php" method="post">
                    ...
                    <input type="hidden" name="tusuario" value="<?php  $i =0; if(!empty($pregadoprimer)){foreach($pregadoprimer as $key) { if($i == 0){echo $key['tipousuario'];$i++;} }}else{echo "Postgrado Primer Semestre";}  ?>">
