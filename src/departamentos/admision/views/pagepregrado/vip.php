                ...
                for($i = 0; $i < count($datos['pregrado_postgrado']['pregrado_postgrado']); $i++){
                    ...
                    for($j = 0; $j < count($datos['usuarios']['usuarios']); $j++){
                        ...
                        if($datos['pregrado_postgrado']['pregrado_postgrado'][$i]['id_pre_post'] == $datos['usuarios']['usuarios'][$j]['id_usuario']){
                            ...
                            if($datos['pregrado_postgrado']['pregrado_postgrado'][$i]['usuario_nuevo_institucion'] == "No" && $datos['usuarios']['usuarios'][$j]['tipo_usuario'] == "Pregrado"){
...
<body>
    ...
    <div class="container" style="height: 95vh; ">
        ...
        <section class="filtros">
            ...
            <h3>Usuarios para carnetizacion: <?php  $i =0; if(!empty($pregadoprimer)){foreach($pregadoprimer as $key) { if($i == 0){echo $key['tipousuario'];$i++;} }}else{echo "Pregrado";}  ?></h3>
            ...
            <div class="bloqFiltro">
                ...
                <button class="btn btnRegistro linea" onclick="window.location.href='rup.php'">Registrar Usuario Nuevo</button>
                ...
                <button class="btn btnRefres" id="actualizar" onclick="window.location.href='../../controlers/controlerscvs/actualizartablatem.php?id=<?php echo $id;?>&actualizar=vip&tipousuario=Pregrado'">
                ...
                <table role="table" id="tableAdmision">
                    ...
                    <?php
                        ...
                        <tr data-tipo="cancelados" style="background-color: hsl(4, 71%, 83%);">
                            ...
                            &tipousuario=Pregrado"><?php echo $value['estado'];  ?></a></td>
    ...
    <!-- <script src="../../../../../public/js/buacadmision.js"></script> -->
