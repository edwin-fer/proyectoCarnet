...
<body>
    ...
    <div class="container">
        <p>Postgrado aprimer Semestre</p>
        <form action="../../controlers/controlerscvs/cvspost.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            Subir Archivo:
            <input type="hidden" name="id" value="<?php echo $_SESSION['id']; ?>">
            <input type="file" name="enviar" id="enviarcvs">
    ...
    function validateForm() {
        const fileInput = document.getElementById('enviarcvs');
        if (!fileInput.value) {
