                ...
                for($i = 0; $i < count($datos['pregrado_postgrado']['pregrado_postgrado']); $i++){
                    ...
                    for($j = 0; $j < count($datos['usuarios']['usuarios']); $j++){
                        ...
                        if($datos['pregrado_postgrado']['pregrado_postgrado'][$i]['id_pre_post'] == $datos['usuarios']['usuarios'][$j]['id_usuario']){
                            ...
                            if($datos['pregrado_postgrado']['pregrado_postgrado'][$i]['usuario_nuevo_institucion'] == "Si" && $datos['usuarios']['usuarios'][$j]['tipo_usuario'] == "Postgrado Primer Semestre"){
...
<body>
    ...
    <div class="container" style="height: 95vh; ">
        ...
        <section class="filtros">
            ...
            <h3>Usuarios para carnetizacion: <?php  $i =0; if(!empty($pregadoprimer)){foreach($pregadoprimer as $key) { if($i == 0){echo $key['tipousuario'];$i++;} }}else{echo "Postgrado Primer Semestre";}  ?></h3>
            ...
            <div class="bloqFiltro">
                ...
                <button class="btn btnRegistro linea" onclick="window.location.href='ruptp.php'">Registrar Usuario Nuevo</button>
                ...
                <button class="btn btnRefres" id="actualizar" onclick="window.location.href='../../controlers/controlerscvs/actualizartablatem.php?id=<?php echo $id;?>&tipousuario=Postgrado Primer Semestre'">
                ...
                <table role="table" id="tableAdmision">
                    ...
                    <?php
                        ...
                        <tr data-tipo="cancelados" style="background-color: hsl(4, 71%, 83%);">
                            ...
                            &tipousuario=Postgrado Primer Semestre"><?php echo $value['estado'];  ?></a></td>
