    ...
    <div class="container" style="height: 200vh; ">
        ...
        <section class="filtros">
            ...
            <div class="bloqFiltro">
                ...
                <button class="btn btnRegistro linea" onclick="window.location.href='../pagejefatura/rujp.php'">Registrar Usuario Nuevo</button>


                


                <button class="btn btnRefres" id="actualizar" onclick="window.location.href='../../controlers/controlerscvs/actualizartablatem.php?id=<?php echo $id;?>&actualizar=Duplicado'">
                ...
                <table role="table" id="tableAdmision">
                    ...
                    <?php
                        ...
                        <tr data-tipo="cancelados" style="background-color: hsl(4, 71%, 83%);">
                            ...
                            onclick="window.location.href='actualizarpre.php?id=<?php echo $value['id_pre_pri'];?>
                            &nombre=<?php echo $value['nombre'];?>
                            &documento=<?php echo $value['documento'];?>
                ...
                <table role="table" id="tableAdmision">
                    ...
                    <?php
                        ...
                        <tr data-tipo="cancelados" style="background-color: hsl(4, 71%, 83%);">
                            ...
                            &tipousuario=Duplicado"><?php echo $value['estado'];  ?></a></td>
                            <td><button class="btn btnRefres"><img src="../../../../../public/imagenes/refrescar.png" alt="" class="btn"
                            onclick="window.location.href='actualizarpost.php?id=<?php echo $value['id_pre_pri'];?>
                            &nombre=<?php echo $value['nombre'];?>
                            &documento=<?php echo $value['documento'];?>
                            &programa=<?php echo $value['programaOcargo'];?>
                            &estadopago=<?php echo $value['estadopago'];?>
