...
<div class="container">
    <button class="back-button" onclick="window.location.href='sasg.php'">Volver Atrás</button>
</div>
<footer class="footer" style="margin-bottom: 20%;">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            alert('¡Lo sentimos, al parecer el archivo introducido no cumple con las normas de registro para los usuarios de Grado!');
        });
    </script>
