...
<body>
    ...
    <div class="container">
        ...
        <form action="../../controlers/enviargra.php" method="post">

            <div class="titulo">
                <h3>Registro de Estudiantes para Grados</h3>
            </div>
            ...
            <div class="bloqueGeneral">
                <div class="bloque">
                    <laber>Fecha de grado: </laber>
                    <input type="text" name="fdg" maxlength="10" oninput="agregarSlashes(this)" required pattern="\d{2}/\d{2}/\d{4}">
                </div> 
                <div class="bloque">
                ...
                <div class="bloque">
                    ...
                    <select name="titulo" id="" required>
                ...
                <input type="hidden" value="No" name="duplicado">
