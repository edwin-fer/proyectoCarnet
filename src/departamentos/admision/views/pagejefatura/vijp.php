    ...
    <div class="container" style="height: 95vh; ">
        ...
        <section class="filtros">
            ...
            <div class="bloqFiltro">
                ...
                <button class="btn btnRegistro linea" onclick="window.location.href='rujp.php'">Registrar Usuario Nuevo</button>
                ...
                <button class="btn btnRefres" id="actualizar" onclick="window.location.href='../../controlers/controlerscvs/actualizartablatem.php?id=<?php echo $id;?>&actualizar=Jefatura'">
