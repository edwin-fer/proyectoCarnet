                    ...
                    <table role="table" id="tablaUsuarios">
                        ...
                        <tbody>
                            ...
                            <tr data-tipo="<?php echo $value['tipousuario'];  ?>">
                                ...
                                <td><a class="btn" onclick="window.location.href='<?php switch($value['tipousuario']){case 'Pregrado Primer Semestre': echo 'duplicadopre.php'; break; case 'Pregrado':echo 'duplicadopre.php'; break; case 'Postgrado Primer Semestre': echo 'duplicadopost.php'; break; case 'Postgrado': echo 'duplicadopost.php'; break; case 'Grado': echo 'duplicadogrd.php'; break; case 'Egresado': echo 'duplicadogrd.php'; break; case 'Jefatura': echo 'duplicadojf.php';break;}?>?id=<?php if($value['tipousuario'] == 'Pregrado Primer Semestre' || $value['tipousuario'] == 'Pregrado' || $value['tipousuario'] == 'Postgrado Primer Semestre' || $value['tipousuario'] == 'Postgrado'){ echo $value['id_pre_pri'];}else if($value['tipousuario'] == 'Grado'){ echo $value['id_grado'];}else if($value['tipousuario'] == 'Egresado'){ echo $value['id_egresado'];}else if($value['tipousuario'] == 'Jefatura'){ echo $value['id_jefatura'];}?>
                                &nombre=<?php echo $value['nombre'];?>
                                &documento=<?php echo $value['documento'];?>
                                &programa=<?php echo $value['programaOcargo']; if($value['tipousuario'] == 'Pregrado Primer Semestre' || $value['tipousuario'] == 'Pregrado' || $value['tipousuario'] == 'Postgrado Primer Semestre' || $value['tipousuario'] == 'Postgrado'){ echo '&estadopago='.$value['estadopago'];} if($value['tipousuario'] == 'Pregrado Primer Semestre' || $value['tipousuario'] == 'Pregrado' || $value['tipousuario'] == 'Postgrado Primer Semestre' || $value['tipousuario'] == 'Postgrado'){ echo '&foto='.$value['foto'];} if($value['tipousuario'] == 'Pregrado Primer Semestre' || $value['tipousuario'] == 'Pregrado' || $value['tipousuario'] == 'Postgrado Primer Semestre' || $value['tipousuario'] == 'Postgrado'){ echo '&correo='.$value['correo'];}?>'">Duplicado</a></td>
