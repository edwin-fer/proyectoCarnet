...
<body>
    ...
    <div class="container" style="height: 95vh; ">
        ...
        <section class="filtros">
            ...
            <h3>Usuarios para carnetizacion: <?php  $i =0; if(!empty($grado)){foreach($grado as $key) { if($i == 0){echo $key['tipousuario'];$i++;} }}else{echo "Egresados";}  ?></h3>
            ...
            <div class="bloqFiltro">
                ...
                <button class="btn btnRegistro linea" onclick="window.location.href='rue.php'">Registrar Usuario Nuevo</button>
                ...
                <button class="btn btnRefres" id="actualizar" onclick="window.location.href='../../controlers/controlerscvs/actualizartablatem.php?id=<?php echo $id;?>&actualizar=Egresado'">
