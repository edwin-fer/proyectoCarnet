    ...
    if(($archivo = fopen($_FILES["enviar"]["tmp_name"], "rb")) !== false){
            ...
            foreach ($titulo as $clave => $subArray) {
                ...
                foreach ($subArray as $subClave => $valor) {
                    echo "<strong>"; echo $valor."<br><br>"; echo "</strong>";
                }
            }
            ...
            if(is_numeric($dataNuevo[1]['documento'])){
                ...
                header('location: ../../views/pagepostprimer/volvercvs.php');
            }
        ...
        for($i = 1; $i <= count($incompletos); $i++){
            ...
            if(is_numeric($incompletos[$i]['documento'])){
                ...
                if(count($incompletos) > 0){
                    if($i == 1){
                        echo "<strong> Listas de persona con los datos incompletos</strong>". "<br><br>" ;
                    }
                ...
                $cont3++;
                    ...
                    echo "<span>"; echo "<strong>"; echo $cont3 . ")</strong>"; echo "<span>"; isset($incompleto[$cont3]['documento'])?$incompleto[$cont3]['documento'] . "  ":""; echo "</span>";
        ...
        // print('<form action="../guardarCvspost.php" method="post" id="myForm">
        ...
        print('<form action="../guardarCvspost.php" method="post">
        <button type="submit" value="edc" name="edc">Enviar Datos Completos</button>
        <button value="etd" name="etd">Enviar Todos los Datos</button>
        </form>') ;
