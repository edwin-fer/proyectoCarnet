    ...
    require_once '../../../usuarios/models/temAdmision.php';
        // Establecer un ID de sesión provisional (solo para pruebas)
                ...
                if($_POST){
                    ...
                    $_SESSION['modelo'] = $_POST['idAdmin'];
                    $_SESSION['tipo'] = $_POST['tusuario'];

                }
                // Define la ruta del archivo JSON temporal en una carpeta del servidor
                $ruta = 'Administrador_id='.$_SESSION['modelo'];
                        ...
                        if($datos){
                            ...
                            if(trim($_SESSION['tipo'])){
                                ...
                                switch($_SESSION['tipo']){
                                    ...
                                    case 'TI':
                                        header('location: ../../views/actdesdepartamento/rdti.php');
                                    break;
                                    
                                    case 'Admision':
                                        header('location: ../../views/actdesdepartamento/rdads.php');
                                    break;
