...
<body>
        ...
        <section class="filtros">
            ...
            <div class="bloqFiltro">
                ...
                <div class="estados linea">
                    <label for="carnt">Estados:</label>
                    <select name="estados" id="carnt">
                ...
                <div class="estados linea">
                    <label for="tipos">Tipos usuarios:</label>
            ...
            <div class="table-pregrado">
                ...
                <table role="table" id="tableAdministrador">
                    ...
                    <?php
                        ...
                        <tr data-tipo="cancelados" style="background-color: hsl(4, 71%, 83%);">
                            ...
                            &solicitud=<?php echo $value['fechaso'];?>"><?php echo $value['estado'];  ?></a></td>
                            <td>Ver</td>
                ...
                <table role="table" id="tableAdministrador">
                    ...
                    <thead role="rowgroup">
                        ...
                        <tr data-tipo="Postgrado" role="row" id="activo">
                            <th role="columnheader">Solicitud</th>
                            <th role="columnheader">Documento</th>
                            <th role="columnheader">Nombre completo</th>
                            <th role="columnheader">Programa</th>
    ...
    <script src="../../../../public/js/administradorti.js">
